...
public final class AssetStore {
    ...
    public List<AssetRecord> load() {
        ...
        if (raw == null || raw.isEmpty()) {
            return AssetStoreMigrations.defaultAssets();
        }
        ...
        try {
            ...
            if (AssetStoreMigrations.migrateStoredAssets(assets, preferences, KEY_SCHEMA_VERSION, SCHEMA_VERSION)) {
    ...
    public AssetBackup parseBackup(String raw) throws JSONException {
        ...
        boolean migratedLegacyAssets = AssetStoreMigrations.migrateImportedAssets(importedAssets);
